      ...
      >
        <defs>
          <linearGradient id="cableGrad" x1="0%" y1="0%" x2="0%" y2="100%">
            ...
            <stop
              offset="100%"
              style={{ stopColor: 'hsl(47, 96%, 40%)', stopOpacity: 1 }}
            />
          </linearGradient>
        </defs>
        ...
        <g transform="translate(50, 200)">
          <text x="0" y="0" className="fill-foreground font-semibold text-sm">
