    ...
    <div className="w-full bg-card rounded-xl p-6 border shadow-sm flex justify-center">
      ...
      >
        ...
        <rect
          ...
          width="300"
          height="400"
          className="fill-muted/30 stroke-muted-foreground stroke-dashed"
          strokeWidth="2"
          strokeDasharray="5,5"
        />
        <text
        ...
        >
          ETEL (Volume réservé : sol au plafond)
        </text>
        ...
        >
          Largeur min: 60 cm (ou largeur GTL + 10cm)
        </text>
        ...
        <text
          ...
          y="395"
          textAnchor="middle"
          className="fill-success text-xs"
        >
          (Prises RJ45, Box)
        </text>
