  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        <rect x="50" y="300" width="700" height="80" fill="#1e293b" stroke="#475569" strokeWidth="2" />
        ...
        />
        <text x="325" y="250" textAnchor="middle" fill="#f8fafc" fontSize="16" fontWeight="bold">
          V0
        </text>

        <rect
          x="200" y="75" width="250" height="125"
          ...
          onMouseLeave={() => setActiveVolume(null)}
        />
        <text x="325" y="140" textAnchor="middle" fill="#f8fafc" fontSize="16" fontWeight="bold">
          V1
        </text>
        ...
        <rect
          x="140" y="75" width="60" height="225"
          ...
          onMouseLeave={() => setActiveVolume(null)}
        />
        <text x="170" y="190" textAnchor="middle" fill="#f8fafc" fontSize="14" fontWeight="bold">
          V2
        </text>

        <rect
          x="450" y="75" width="60" height="225"
          fill={activeVolume === 'v2' ? volumes.v2.color : '#1e3a8a'}
          fillOpacity={activeVolume === 'v2' ? 0.6 : 0.3}
          stroke={volumes.v2.color}
          strokeWidth="3"
          ...
          onMouseLeave={() => setActiveVolume(null)}
        />
        <text x="480" y="190" textAnchor="middle" fill="#f8fafc" fontSize="14" fontWeight="bold">
          V2
        </text>

        <rect
          x="50" y="75" width="90" height="225"
        ...
        <line x1="200" y1="300" x2="200" y2="320" stroke="#f59e0b" strokeWidth="2" />
        <line x1="450" y1="300" x2="450" y2="320" stroke="#f59e0b" strokeWidth="2" />
        <line x1="200" y1="310" x2="450" y2="310" stroke="#f59e0b" strokeWidth="2" />
      ...
      {activeVolume && (
        <div className="p-4 rounded-lg border" style={{ borderColor: volumes[activeVolume as keyof typeof volumes].color }}>
          <h3 className="font-semibold text-lg mb-2" style={{ color: volumes[activeVolume as keyof typeof volumes].color }}>
          ...
          <p className="text-sm font-medium">
            Protection : {volumes[activeVolume as keyof typeof volumes].protection}
          </p>
        </div>
      )}
        ...
        {Object.entries(volumes).map(([key, vol]) => (
          ...
          >
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 rounded" style={{ backgroundColor: vol.color }} />
