                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between gap-2">
                        <CardTitle className="text-2xl group-hover:text-primary transition-colors drop-shadow-md">
                          {domain.name}
                        </CardTitle>
                        <Badge
                          variant="secondary"
                          className="group-hover:bg-primary/20 transition-colors shrink-0 backdrop-blur-md bg-background/50 border-white/10"
                        >
                          {domain.sheetCount} fiches
                        </Badge>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {domain.subDomains.slice(0, 3).map((sub) => (
                          <Badge
                            key={sub.id}
                            variant="outline"
                            className="bg-background/40 backdrop-blur-sm border-white/10 hover:bg-primary/20 hover:border-primary/30 transition-all duration-300"
                          >
                            {sub.name}{' '}
